...
export default function PricingPlan({ perks, mostPopular = false, planName, description, price }) {
    return (
      <div id='pricing' className="border-border dark:border-darkBorder dark:bg-brand-dark flex flex-col justify-between rounded-base border-2 bg-white p-5 shadow-light dark:shadow-dark">
        <div>
